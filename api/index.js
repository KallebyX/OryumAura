...
// Em ambientes serverless (Vercel), usar apenas Console transport
// pois o filesystem é read-only
...
// Adiciona file transports apenas em ambiente local (não serverless)
if (!isServerless) {
